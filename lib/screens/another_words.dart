...
class AnotherWordsScreen extends StatefulWidget {


  const AnotherWordsScreen({super.key  } );

  @override
  State<AnotherWordsScreen> createState() => _SavedWardsState();
}

class _SavedWardsState extends State<AnotherWordsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:   SafeArea(
        child: FutureBuilder( future: anotherWords.readWords(), initialData: [] ,  builder: (c,snapshot){
                                          ...
                                          Container(
                                              ...
                                              child:  Row(
                                                children: [
                                                  ...
                                                  InkWell(
                                                    onTap: ()async{
                                                      int deletedRwa =    await  anotherWords.deleteWord(en_word: dataList[i]['en_word']);
                                                      if(deletedRwa != -1){
                                                        setState(() {
                                          ...
                                          Container(
                                              ...
                                              child:   Row(
                                                children: [
                                                  ...
                                                  InkWell(
                                                    onTap: ()async{
                                                      bool isFound  =    await  db.searchWord(en_word: dataList[i]['en_word']);

                                                      if(isFound){
                                                        int x=    await  db.deleteWord(en_word: dataList[i]['en_word']);
                                                        ...
                                                        int x=    await  db.insertWord(arabicWord: dataList[i]['ar_word'] , englishWord: dataList[i]['en_word'] ,
